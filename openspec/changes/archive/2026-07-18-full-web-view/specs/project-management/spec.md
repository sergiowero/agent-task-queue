...
The system SHALL allow users to update project metadata.

#### Scenario: Update project fields
- **WHEN** user provides a project ID and updated fields (name, displayName, workingDirectory)
- **THEN** system updates the project record and returns the updated object

#### Scenario: Update non-existent project
- **WHEN** user attempts to update a project with an invalid ID
