    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 animate-fade-in">
      <div className="bg-surface rounded-xl shadow-lg w-full max-w-sm p-6 transition-colors duration-300">
        ...
        <p className="text-sm text-text-secondary mb-4">
          ...
          <span className="font-medium text-text">{project.displayName}</span>? Tasks in this
          project will become orphaned.
        </p>
...
export function ProjectsPage() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      {deletingProject && (
        <DeleteConfirmModal project={deletingProject} onClose={() => setDeletingProject(null)} />
      )}
    </div>
  );
}
