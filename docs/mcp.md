...
| `get_task_brief` | What an agent needs to continue a task: approved plan and validation, criteria, open findings, latest handoff per phase, project commands/guardrails, round, and what people said since the last submission. Its size does not grow with rounds. |
