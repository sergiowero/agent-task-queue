...
| `get_task_brief` | What an agent needs to continue a task: approved plan and validation, criteria, open findings, latest handoff per phase, project commands/conventions/guardrails, round, and what people said since the last submission. Its size does not grow with rounds. |
| `get_skill`     | The current text and version of an AgentQ skill, as this server ships it.                                                                                                                                                  |
| `get_task`      | Fetch a task by ID with its project, its review `findings`, its `evidence` and its `handoffs`.                                                                                                                                           |
