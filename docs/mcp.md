...
| --------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `claim_task`    | `toolName`, `version`, `model`, `role` (`refiner`, `planner`, `plan_reviewer`, `implementer`, `verifier`, `reviewer`, `integrator`, `senior`, `architect`, `qa`, `builder`), `sessionId` | `host`, `projectId`, `skillsVersion`, `context`                                                                        |
